  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-opacity-30 backdrop-blur-sm p-4">
      <div className="relative bg-white rounded-2xl shadow-2xl max-w-[90vw] max-h-[90vh] w-full overflow-auto p-6">
        ...
        <h2 className="text-3xl font-extrabold mb-6 text-center text-blue-800 select-none">
              ...
              <tr>
                ...
                {days.map((day) => {
                  ...
                  const isHoliday = filtered.some(
                    (item) => item[`Date${day}`] === "2" && day <= loopUntil
                  );
                  ...
                  return (
                    <th
                      ...
                      className={`border border-gray-300 p-2 text-center text-xs font-medium text-gray-600 select-none relative ${
                        isToday ? "animate-pulse bg-yellow-200/60" : ""
